...
img {
  ...
  margin-right: auto;
   ...
   <body style="margin:20px;background-color:#E2D0BE;"> 

    
    <div>
        <img src="foxlogo.png" width = "600" height = "150"  style="vertical-align:middle">
        </div>
...
<div>
  ...
  <li class="nav-item">
    <a class="nav-link" href="/edu.html">Other Social Issues</a>
  </li>
  <li class="nav-item">
